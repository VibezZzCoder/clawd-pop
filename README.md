...
with an Options screen for look sensitivity, inverted aim, touch auto-fire and
graphics quality; Walker, Runner and Heavy specimens; escalating laboratory
sectors; and a final swarm encounter. Audio options and further effects polish
are planned.
...
**Options** is on the title screen and on the pause screen. It carries look
sensitivity for mouse and touch, inverted vertical aim, auto-fire on touch, and
graphics quality.
...
restarts, and a final chamber whose boss releases mini-Clawd swarms.
